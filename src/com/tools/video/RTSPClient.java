...
public class RTSPClient  extends Thread implements IEvent{
    ...
    public static void main(String[] args) {  
        try {  
            RTSPClient client = new RTSPClient(new InetSocketAddress(  
                    "192.168.20.107", 554),  
                    new InetSocketAddress("192.168.20.225", 16264),  
                    "rtsp://admin:admin@192.168.20.107:554/cam/realmonitor?channel=1&subtype=0 ");  
            client.start();  
            
                Thread.sleep(2000);
                client.sysStatus=Status.play;
    ...
    private void doSetup() {  
        ...
        sb.append(seq++);  
        sb.append("/r/n");  
        sb.append("Transport: RTP/AVP/TCP;UNICAST;client_port=16264-16265;mode=play/r/n");  
        sb.append("/r/n");  
        System.out.println(sb.toString());  
        send(sb.toString().getBytes());  
    }  
